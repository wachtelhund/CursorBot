...
export const en = {
  ...
  phoneInternet: "Internet link",
  phoneInternetStop: "Stop internet link",
  phoneInternetWait: "Starting tunnel…",
  phoneNoLan: "No local network address yet. Check Wi‑Fi.",
  phoneLinks: "Local links",
  team: "Team",
  chats: "Chats",
  newBot: "New bot",
